      ...
      <div className="my-10 flex flex-row gap-x-5 rounded-md border-[1px] border-pink-700 bg-pink-900 p-8 px-6 sm:px-12">
        ...
        <div className="flex flex-col ">
          ...
          <div className="sm:w-3/5 text-pink-25 flex flex-col gap-3 mt-1">
            <p>¿Querés eliminar tu cuenta?</p>
            <p>
              Eliminar tu cuenta es irreversible. Todo el contenido asociado con
              la misma será eliminado también.
            </p>
          </div>
            ...
            <button
              ...
              onClick={() =>
                ...
                setConfirmationModal({
                  text1: '¿Querés continuar?',
                  text2: 'Eliminar la cuenta',
                  btn1Text: 'Eliminar',
                  btn2Text: 'Cancelar',
