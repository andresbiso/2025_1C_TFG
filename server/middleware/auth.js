...
exports.isStudent = (req, res, next) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      error: error.message,
      messgae: 'Error while checking user validity with student accountType',
    });
  }
};
...
exports.isInstructor = (req, res, next) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      error: error.message,
      messgae: 'Error while checking user validity with Instructor accountType',
    });
  }
};
...
exports.isAdmin = (req, res, next) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      error: error.message,
      messgae: 'Error while checking user validity with Admin accountType',
    });
  }
};
